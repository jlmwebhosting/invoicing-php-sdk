...
<xsl:stylesheet version="1.0"
	...
	<!-- <xsl:template match="*[local-name()='binding']"> <functions> <xsl:apply-templates 
		select=".//*[local-name()='operation' and namespace-uri()='http://schemas.xmlsoap.org/wsdl/']" 
		/> </functions> </xsl:template> -->
